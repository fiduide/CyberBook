...
$req->execute(array(htmlspecialchars($_POST['isbn']), htmlspecialchars($_POST['titre']),$_POST['editeur'], htmlspecialchars($_POST['annee']), $_POST['genre'], $_POST['langue'], htmlspecialchars($nbpages)));
